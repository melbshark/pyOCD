...
class MAX32620HSP(CoreSightTarget):

    memoryMap = MemoryMap(
        FlashRegion(    start=0,           length=0x200000,      blocksize=0x2000, isBootMemory=True),
    ...
    def __init__(self, link):
        super(MAX32620HSP, self).__init__(link, self.memoryMap)
